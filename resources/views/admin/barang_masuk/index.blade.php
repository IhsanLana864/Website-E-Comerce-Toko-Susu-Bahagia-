            ...
            <div class="col-md-9 col-lg-10 p-4">
                <div class="card p-4" style="background-color: #fed3d3; border-radius: 20px;">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('admin.masuk.create') }}" class="btn text-white px-4"
                    ...
                    <div class="table-responsive">
                        @if ($barangMasuk->isEmpty())
                            <div class="col-12 text-center">
                                <p class="text-muted">Barang Masuk Kosong</p>
                            </div>
                        @else
                                ...
                                <tbody>
                                    @foreach($barangMasuk as $item)
                                        <tr style="background-color: #FFE5E5; border-radius: 12px;">
                                            ...
                                            <td>{{ $item->penerima }}</td>
                                            <td>
                                                <a href="{{ route('admin.masuk.edit', $item->id) }}" class="btn btn-sm text-white"
                                                    style="background-color: #003366; border-radius: 6px;">Edit</a>
                                                <a href="{{ route('admin.masuk.show', $item->id) }}" class="btn btn-sm btn-primary">Show</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
